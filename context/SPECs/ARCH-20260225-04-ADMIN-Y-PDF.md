...
1. El Administrador puede dar de alta un nuevo `Médico Validador` en la interfaz.
2. El Administrador puede crear 2 nuevos Servicios y meterlos en un Perfil de Servicio.
3. Al aprobar un expediente (Medical Board), el sistema crea y provee un PDF oficial del Dictamen Médico.
4. Un cliente logueado en el Portal B2B puede descargar dicho PDF.
