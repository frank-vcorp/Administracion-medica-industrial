-- =====================================================================
-- IMPL-20260701-03 — Migración consolidada Slice B NOVA Admisión LabOrder
-- Aplicar via Railway Query Editor o psql.
-- Idempotente en cada parte.
-- =====================================================================
...
-- =====================================================================
-- Registrar Slice B como aplicada en _prisma_migrations (idempotente)
-- =====================================================================
INSERT INTO _prisma_migrations (id, migration_name, checksum, finished_at, applied_steps_count)
VALUES (
  gen_random_uuid()::text,
  '20260701010000_add_lab_orders',
  md5('20260701010000_add_lab_orders') || md5('20260701010000_add_lab_orders'),
  NOW(),
  1
)
...
-- =====================================================================
-- VERIFICACIÓN FINAL — debería listar 21 migraciones todas finalizadas
-- =====================================================================
SELECT COUNT(*) AS total_migraciones_finalizadas
