/**
 * ARCH-20260326-06 — Editor Maestro Longitudinal
 * @see SPEC_ARCH-20260326-06-HISTORIAL-MAESTRO-TRANSICION.md
 */
...
export default async function HistoryPage(props: HistoryPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Editor Maestro Longitudinal — ARCH-20260326-06 */}
      ...
      {process.env.NODE_ENV === 'development' && (
        <div className="max-w-4xl mx-auto mt-4 border-t border-dashed pt-4 mb-8 text-center text-xs text-gray-400">
          <p>Worker: {worker.id.slice(-6)} | History: {initialData ? 'Cargada' : 'Nueva'}</p>
        </div>
      )}
    </div>
  )
